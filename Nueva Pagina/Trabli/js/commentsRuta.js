...
function cargarComentarios(){
  ...
  xhttp.open("GET", "../php/getComentariosRutaResp.php?id=" + myParam, true);
  xhttp.send();
}
...
function sendMail(){
  ...
  xhttp.open("GET", "../php/sendMail.php?id=" + commentSelect+"&mail="+commentMail+"&content="+content+"&empresa="+empresa, true);
  xhttp.send();
}
